...
public partial class RealEstateAgencyContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("Server=localhost;Database=RealEstateAgency;Trusted_Connection=True;Encrypt=false;");
